...
class _HomeScreenState extends State<HomeScreen>
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            // Gateway-only options removed - "Đổi WiFi" option disabled
  ...
  // WiFi Config removed - Gateway uses Cellular connection
  // void _showWiFiConfig(BuildContext context, Device device) was here - REMOVED
